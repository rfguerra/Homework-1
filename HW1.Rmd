...
**1.**Supervised learning demonstrates the existence of a response measurement y_i associated to individual measurement observations x_i, i= 1,...,n of the predictor. Predicts responses that are known.
